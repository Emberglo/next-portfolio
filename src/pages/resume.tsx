...
const resume = () => {
  return (
    <div className='w-full my-2 flex flex-col items-center'>
      ...
      <p className='w-5/6 my-3'>A passionate software developer with a track record of delivering enterprise-level full stack applications, collaborating with a team to achieve and surpass goals, and crafting visually stunning and intuitive user interfaces.</p>
