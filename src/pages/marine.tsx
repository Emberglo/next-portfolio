  ...
  return (
    <div className='w-full full-height flex flex-col items-center'>
      ...
      <div className='flex flex-col items-center w-5/6 my-6'>
        ...
        <p>
          New functionality was added to make the application more useful to current users and to attract new users. Live tracking via sattelite was integrated through auxillary equipment and an external API. User controllable permissions were added so that fleet managers can grant subordinate employees access to only the features they are responsible for.
        </p>
        <p>
          A React application was integrated to allow fleet managers to create custom forms so employees can track information important to the organization or to regulators.
        </p>
      </div>
      <div className='flex flex-col items-center w-5/6 my-6'>
